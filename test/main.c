...
/*   Updated: 2021/05/01 19:38:09 by lpinheir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	a = printf("printf  %%9.0s   : |%9.0s|\n", "hello");
	b = ft_printf("ft_printf       : |%9.0s|\n", "hello");
	printf("a: %d b: %d\n\n", a, b); 
	...
	a = printf("printf  %%15.*s   : |%15.*s|\n", -3, "hello");
	b = ft_printf("ft_printf        : |%15.*s|\n", -3, "hello");
	printf("a: %d b: %d\n\n", a, b); 
